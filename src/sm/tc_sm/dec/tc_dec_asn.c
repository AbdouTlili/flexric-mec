...
tc_event_trigger_t tc_dec_event_trigger_asn(size_t len, uint8_t const buf[len])
{
  assert(0!=0 && "Not implemented");
  assert(buf != NULL);
  tc_event_trigger_t avoid_warning;
...
tc_call_proc_id_t tc_dec_call_proc_id_asn(size_t len, uint8_t const call_proc_id[len])
{
  ...
  tc_call_proc_id_t avoid_warning;
  return avoid_warning;
}
...
tc_ctrl_out_t tc_dec_ctrl_out_asn(size_t len, uint8_t const ctrl_out[len]) 
{
 ...
 tc_ctrl_out_t avoid_warning;
  return avoid_warning;
}

tc_func_def_t tc_dec_func_def_asn(size_t len, uint8_t const func_def[len])
{
  assert(0!=0 && "Not implemented");
  assert(func_def != NULL);
 tc_func_def_t  avoid_warning;
  return avoid_warning;
}
