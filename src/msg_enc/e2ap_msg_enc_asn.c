...
{
  assert(pdu != NULL);
  byte_array_t ba = {.buf = malloc(10500), .len = 10500};
...
{
  e_RICindicationType ric_ind_type = ind->type; 
...
E2AP_PDU_t* e2ap_enc_control_ack_asn_pdu(const ric_control_acknowledge_t* ca)
{
  ...
  e_RICcontrolStatus ctrl_status = ca->status;
