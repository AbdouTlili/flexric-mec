...
#define ProtocolIE_ID_id_XAPP_ID	((ProtocolIE_ID_t)49)
#define ProtocolIE_ID_id_E2nodesConnected	((ProtocolIE_ID_t)50)
#define ProtocolIE_ID_id_NODEfunctionID_Item	((ProtocolIE_ID_t)51)
